...
#
# Created: Fri Jul 18 17:51:13 2014
...
class Ui_ProfileWindow(object):
    def setupUi(self, ProfileWindow):
        ...
        self.line_2.setGeometry(QtCore.QRect(0, 280, 500, 20))
        ...
        self.layoutWidget2.setGeometry(QtCore.QRect(40, 310, 414, 101))
    ...
    def retranslateUi(self, ProfileWindow):
        ...
        self.label_34.setText(_translate("ProfileWindow", "y-Ø (μm)", None))
        self.label_35.setText(_translate("ProfileWindow", "3", None))
        self.label_36.setText(_translate("ProfileWindow", "x-Ø (μm)", None))
        ...
        self.label_16.setText(_translate("ProfileWindow", "3", None))
        ...
        self.label_11.setText(_translate("ProfileWindow", "Ø (μm)", None))
        ...
        self.label_14.setText(_translate("ProfileWindow", "3", None))
        self.label_15.setText(_translate("ProfileWindow", "Divergence (θ)", None))
        ...
        self.label_29.setText(_translate("ProfileWindow", "y-Ø (μm)", None))
        self.label_27.setText(_translate("ProfileWindow", "3", None))
        self.label_28.setText(_translate("ProfileWindow", "x-Ø (μm)", None))
